...
export default function AuthorSidebar({
  ...
  return (
    <div className="bg-white dark:bg-neutral-900 rounded-[2rem] p-8 border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm flex flex-col items-center text-center sticky top-32">
      ...
      {profile.donationLink && (
        <Link
          ...
          target="_blank"
          className="w-full bg-[#E5481B] hover:bg-[#c93b12] text-white font-bold py-3.5 px-6 rounded-2xl transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
        >
          Помочь уроку
        </Link>
      )}
