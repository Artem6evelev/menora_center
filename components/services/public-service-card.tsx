    ...
    >
      ...
      >
        ...
        <div className="p-6 sm:p-8 overflow-y-auto flex-1">
          {/* Плашки с ценой и временем в новом стиле */}
          <div className="flex flex-wrap gap-3 mb-8">
            {service.price && (
              <div className="flex items-center gap-2 bg-neutral-100 text-neutral-900 px-4 py-2.5 rounded-xl border border-neutral-200 font-bold text-sm">
                <Banknote size={18} className="text-[#FFB800]" />
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-6 z-10">
          <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              {service.price && (
                <span className="bg-white/20 backdrop-blur-md border border-white/20 text-white px-2.5 py-1 rounded-lg text-xs font-bold">
                  {service.price}
                </span>
              )}
              {service.duration && (
                <span className="text-neutral-300 text-xs font-medium flex items-center gap-1">
                  <Clock size={12} />
                  {service.duration}
                </span>
              )}
