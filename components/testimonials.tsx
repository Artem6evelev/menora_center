  ...
  return (
    <div className="relative z-20 py-10 md:py-40">
      ...
      <Subheading className="text-center max-w-2xl mx-auto">
        ...
        Menora Center становится для многих настоящим вторым домом.
      </Subheading>
      <TestimonialGrid />
    </div>
  );
...
const testimonials: Testimonial[] = [
  ...
  },
  {
    name: "Анна Коэн",
    quote:
      "Я долго искала общину, где бы меня приняли тепло и без осуждения за то, что я пока мало знаю о традициях. Menora Center — именно такое место. Здесь очень много света.",
